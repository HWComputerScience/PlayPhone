...
public class ControlObject extends Serializable {
  ...
  public void setImg(SWIGTYPE_p_string value) {
    openpadJNI.ControlObject_img_set(swigCPtr, this, SWIGTYPE_p_string.getCPtr(value));
  }

  public SWIGTYPE_p_string getImg() {
    return new SWIGTYPE_p_string(openpadJNI.ControlObject_img_get(swigCPtr, this), true);
  }
