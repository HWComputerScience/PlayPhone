...
public class PadConfig extends Serializable {
  ...
  public void setBgimg(SWIGTYPE_p_string value) {
    openpadJNI.PadConfig_bgimg_set(swigCPtr, this, SWIGTYPE_p_string.getCPtr(value));
  }

  public SWIGTYPE_p_string getBgimg() {
    return new SWIGTYPE_p_string(openpadJNI.PadConfig_bgimg_get(swigCPtr, this), true);
  }
